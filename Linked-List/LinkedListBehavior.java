...
public interface LinkedListBehavior{
	...
	public boolean isEmpty();			// Return true if the LinkedList is empty, otherwise false. You can check if a LinkedList is empty by simply checking if the head Node is null OR not.
